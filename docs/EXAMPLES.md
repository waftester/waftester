...
WAFtester v2.9.5 - WAF Security Assessment Tool
...
WAFtester v2.9.5 — Comprehensive WAF Security Assessment
...
WAFtester v2.9.5 — Enterprise WAF Assessment
...
WAFtester v2.9.5 — Targeted Vulnerability Scan
...
WAFtester v2.9.5 — WAF Vendor Detection
...
WAFtester v2.9.5 — Protocol Detection
...
WAFtester v2.9.5 — WAF Bypass Hunter
...
WAFtester v2.9.5 — Mutation Testing
...
WAFtester v2.9.5 — False Positive Testing
...
WAFtester v2.9.5 — HTTP Smuggling Detection
...
WAFtester v2.9.5 — Race Condition Testing
...
WAFtester v2.9.5 — JavaScript Analysis
...
WAFtester v2.9.5 — Headless Browser Testing
...
WAFtester v2.9.5 — Endpoint Discovery
...
WAFtester v2.9.5 — Test Execution
...
WAFtester v2.9.5 — Workflow Orchestration
...
```xml
<?xml version="1.0" encoding="UTF-8"?>
<waftester-report version="2.9.5" generatedAt="2026-02-03T14:30:00Z">
  <generator>
    <name>WAFtester</name>
...
```json
{
  "blocks": [
    ...
    },
    {
      "type": "context",
      "elements": [
        { "type": "mrkdwn", "text": "WAFtester v2.9.5 | Scan ID: a1b2c3d4 | 2026-02-03T14:30:00Z" }
      ]
    }
  ]
}
  ...
  "resourceSpans": [
    {
      "resource": {
        "attributes": [
          ...
          { "key": "service.version", "value": { "stringValue": "2.9.5" } }
        ]
      },
      "scopeSpans": [
        {
...
docker run -p 8080:8080 ghcr.io/waftester/waftester:2.9.5
```
