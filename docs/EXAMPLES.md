...
WAFtester v2.9.46 - WAF Security Assessment Tool
...
WAFtester v2.9.46 — Comprehensive WAF Security Assessment
...
WAFtester v2.9.46 — Enterprise WAF Assessment
...
WAFtester v2.9.46 — Targeted Vulnerability Scan
...
WAFtester v2.9.46 — WAF Vendor Detection
...
WAFtester v2.9.46 — Protocol Detection
...
WAFtester v2.9.46 — WAF Bypass Hunter
...
WAFtester v2.9.46 — Mutation Testing
...
WAFtester v2.9.46 — False Positive Testing
...
WAFtester v2.9.46 — HTTP Smuggling Detection
...
WAFtester v2.9.46 — Race Condition Testing
...
WAFtester v2.9.46 — JavaScript Analysis
...
WAFtester v2.9.46 — Headless Browser Testing
...
WAFtester v2.9.46 — Endpoint Discovery
...
WAFtester v2.9.46 — Test Execution
...
WAFtester v2.9.46 — Workflow Orchestration
...
```xml
<?xml version="1.0" encoding="UTF-8"?>
<waftester-report version="2.9.46" generatedAt="2026-02-03T14:30:00Z">
  <generator>
    <name>WAFtester</name>
...
```json
{
  "blocks": [
    ...
    },
    {
      "type": "context",
      "elements": [
        { "type": "mrkdwn", "text": "WAFtester v2.9.46 | Scan ID: a1b2c3d4 | 2026-02-03T14:30:00Z" }
      ]
    }
  ]
}
  ...
  "resourceSpans": [
    {
      "resource": {
        "attributes": [
          ...
          { "key": "service.version", "value": { "stringValue": "2.9.46" } }
        ]
      },
      "scopeSpans": [
        {
...
```text
WAFtester v2.9.46 — Assessment Complete
Target:    https://example.com
...
docker run -p 8080:8080 ghcr.io/waftester/waftester:2.9.46
```
...
VERSION=2.9.46 COMMIT=$(git rev-parse --short HEAD) \
