...
WAFtester v2.9.29 - WAF Security Assessment Tool
...
WAFtester v2.9.29 — Comprehensive WAF Security Assessment
...
WAFtester v2.9.29 — Enterprise WAF Assessment
...
WAFtester v2.9.29 — Targeted Vulnerability Scan
...
WAFtester v2.9.29 — WAF Vendor Detection
...
WAFtester v2.9.29 — Protocol Detection
...
WAFtester v2.9.29 — WAF Bypass Hunter
...
WAFtester v2.9.29 — Mutation Testing
...
WAFtester v2.9.29 — False Positive Testing
...
WAFtester v2.9.29 — HTTP Smuggling Detection
...
WAFtester v2.9.29 — Race Condition Testing
...
WAFtester v2.9.29 — JavaScript Analysis
...
WAFtester v2.9.29 — Headless Browser Testing
...
WAFtester v2.9.29 — Endpoint Discovery
...
WAFtester v2.9.29 — Test Execution
...
WAFtester v2.9.29 — Workflow Orchestration
...
```xml
<?xml version="1.0" encoding="UTF-8"?>
<waftester-report version="2.9.29" generatedAt="2026-02-03T14:30:00Z">
  <generator>
    <name>WAFtester</name>
...
```json
{
  "blocks": [
    ...
    },
    {
      "type": "context",
      "elements": [
        { "type": "mrkdwn", "text": "WAFtester v2.9.29 | Scan ID: a1b2c3d4 | 2026-02-03T14:30:00Z" }
      ]
    }
  ]
}
  ...
  "resourceSpans": [
    {
      "resource": {
        "attributes": [
          ...
          { "key": "service.version", "value": { "stringValue": "2.9.29" } }
        ]
      },
      "scopeSpans": [
        {
...
```text
WAFtester v2.9.29 — Assessment Complete
Target:    https://example.com
...
docker run -p 8080:8080 ghcr.io/waftester/waftester:2.9.29
```
...
VERSION=2.9.29 COMMIT=$(git rev-parse --short HEAD) \
