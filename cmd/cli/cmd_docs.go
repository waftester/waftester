...
func printUsage() {
	...
	fmt.Printf("  %s  %s\n", ui.StatValueStyle.Render("template"), "🆕 Run Nuclei-compatible YAML templates")
	fmt.Printf("  %s  %s\n", ui.StatValueStyle.Render("grpc    "), "🆕 gRPC service testing via reflection API")
	fmt.Printf("  %s  %s\n", ui.StatValueStyle.Render("soap    "), "🆕 SOAP/WSDL testing and fuzzing")
	fmt.Printf("  %s  %s\n", ui.StatValueStyle.Render("openapi "), "🆕 OpenAPI/Swagger specification fuzzing")
	fmt.Printf("  %s  %s\n", ui.StatValueStyle.Render("cicd    "), "🆕 Generate CI/CD pipeline configurations")
	fmt.Printf("  %s  %s\n", ui.StatValueStyle.Render("plugin  "), "🆕 Plugin management (list, load, run)")
	fmt.Printf("  %s  %s\n", ui.StatValueStyle.Render("cloud   "), "🆕 Cloud resource discovery (AWS/Azure/GCP)")
	fmt.Println()
	fmt.Printf("  %s\n", ui.SubtitleStyle.Render("Integration:"))
	fmt.Printf("  %s  %s\n", ui.StatValueStyle.Render("mcp     "), "🆕 MCP server for AI assistant integration (Claude, VS Code, etc.)")
	fmt.Println()
...
func printDocsMcp() {
	fmt.Println(ui.SectionStyle.Render("🤖 MCP SERVER - DETAILED DOCUMENTATION"))
	fmt.Println()
	...
	fmt.Println("  • WAF detection: reports each detection technique as it runs")
	fmt.Println("  • Scanning: streams per-payload results with bypass notifications")
	fmt.Println("  • All tools report progress via MCP progress notifications")
	fmt.Println()
...
func printDocsTemplates() {
	fmt.Println(ui.SectionStyle.Render("📋 TEMPLATE LIBRARY - DETAILED DOCUMENTATION"))
	fmt.Println()
